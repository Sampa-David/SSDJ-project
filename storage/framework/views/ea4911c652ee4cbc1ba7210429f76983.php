...
<?php $__env->startSection('title', 'Events - Eventix'); ?>
                                ...
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <div>
                                        ...
                                        <small>
                                            ...
                                            <?php echo e($event->date_event->format('l, F d, Y')); ?>
                            ...
                            <div style="padding: 20px;">
                                ...
                                <div class="mb-3">
                                    <small class="text-muted">
                                        ...
                                        <strong>Organizer:</strong> <?php echo e($event->user->name ?? 'Unknown'); ?>
                                ...
                                <?php if($event->package_type): ?>
                                    <div class="mb-3 pb-3" style="border-bottom: 1px solid #e0e0e0;">
                                        <small class="text-muted">
                                            ...
                                            <strong>Package:</strong> <?php echo e(ucfirst($event->package_type)); ?>
                                ...
                                <div class="d-grid gap-2">
                                    <a href="<?php echo e(route('events.public.show', $event->id)); ?>" class="btn btn-primary">
                                        View Details
                                    </a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH S:\php(Laravel)\S²DJ\resources\views/events/public-list.blade.php ENDPATH**/ ?>