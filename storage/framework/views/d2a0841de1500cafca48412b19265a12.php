    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
        <div class="hero-image-wrapper">
          <img src="<?php echo e(asset('assets/img/events/gallery-7.webp')); ?>" alt="Global Tech Summit" class="img-fluid hero-image">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6">
        <div class="image-wrapper" data-aos="zoom-in" data-aos-delay="300">
          <img src="<?php echo e(asset('assets/img/events/showcase-8.webp')); ?>" alt="Event showcase" class="img-fluid">
        </div>
      </div>
    </div>
  </div>
