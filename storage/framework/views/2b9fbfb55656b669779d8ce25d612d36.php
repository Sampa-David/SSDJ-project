                    ...
                    <div class="card-body p-5">
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="h5 fw-bold"><?php echo e($user->name); ?></p>
                            </div>
                            <div class="col-md-6 mb-3">
                                <p class="text-muted small mb-1">
                                    <i class="fas fa-envelope" style="color: #667eea;"></i> Email Address
                                </p>
                                <p class="h5 fw-bold"><?php echo e($user->email); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="h5 fw-bold">
                                    <?php echo e($user->company ?? 'Not provided'); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="h5 fw-bold"><?php echo e($user->created_at->format('F d, Y')); ?></p>
                            </div>
                            <div class="col-md-6 mb-3">
                                <p class="text-muted small mb-1">
                                    <i class="fas fa-sync-alt" style="color: #667eea;"></i> Last Updated
                                </p>
                                <p class="h5 fw-bold"><?php echo e($user->updated_at->format('F d, Y \a\t H:i')); ?></p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card shadow-sm border-0 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <h3 class="mb-0 text-primary"><?php echo e($user->events()->count()); ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH S:\php(Laravel)\S²DJ\resources\views/profile/show.blade.php ENDPATH**/ ?>