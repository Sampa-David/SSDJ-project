        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    ...
                    <a href="{{ route('events.payment') }}" class="btn btn-warning btn-sm mt-2">
                    ...
                    <div class="card-header bg-gradient text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="mb-0 small">
                                    Active until: <strong>{{ auth()->user()->getActivePublishingRight()->expires_at->format('M d, Y') }}</strong>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="{{ route('events.store') }}" method="POST" class="event-form">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                       id="name" name="name" placeholder="Enter event name" value="{{ old('name') }}" required>
                                @error('name')
