...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') - SSDJ</title>
    ...
    <div class="admin-wrapper">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="{{ route('admin.users') }}" class="@if(Route::currentRouteName() === 'admin.users' || Route::currentRouteName() === 'admin.user') active @endif">
                        <i class="fas fa-users"></i>
                        <span>Users</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.tickets') }}" class="@if(Route::currentRouteName() === 'admin.tickets' || Route::currentRouteName() === 'admin.ticket') active @endif">
                ...
                <li>
                    <a href="{{ route('admin.data-generator.show') }}" class="@if(Route::currentRouteName() === 'admin.data-generator.show') active @endif">
